	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" selected=<%="1".equals(purchase.getPaymentOption()) ? "selected" : "" %>"selected">현금구매</option>
				<option value="2" selected=<%="2".equals(purchase.getPaymentOption()) ? "selected" : "" %>"selected">신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="receiverName" 	class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="<%=purchase.getReceiverName() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverPhone" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="<%=purchase.getReceiverPhone() %>" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverAddr" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" 	value="<%=purchase.getDlvyAddr() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input		type="text" name="receiverRequest" 	class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="<%=purchase.getDlvyRequest()%>"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
